...
@register('protonet_5way_traintest_1shot_disentangle')
def protonet_5way_traintest_1shot_disentangle():
    comment = '-protonet-5way-traintest-1shot_disentangle'
    ...
    __config.cfg_name = 'protonet-5way-1shot'
