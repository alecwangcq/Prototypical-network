...
@register('protonet_5way_5shot_feature_attn')
def protonet_5way_5shot_feature_attn():
    comment = '-protonet-5way-5shot-feature-attn'
    ...
    __config.cfg_name = 'protonet-5way-5shot-feature-attn'
