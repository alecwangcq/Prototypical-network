...
@register('protonet_5way_5shot_maml')
def protonet_5way_5shot_maml():
    comment = '-protonet-5way-5shot_maml'
    ...
    __dataloader.separate_metasample = {'train': True, 'val': True, 'test': False}
    __dataloader.metasample_holdout = 200
    ...
    # setup training
    __training = edict()
    __training.pretrain_episodes = 0
    __training.max_episodes = 50000
    ...
    __training.nquery = 1
    __training.nmeta = 15
    __training.num_updates = 5
    __training.inner_lr = 0.01
    ...
    __testing.nquery = 1
    __testing.nmeta = 15
    __testing.num_updates = 10
    __testing.inner_lr = 0.01
